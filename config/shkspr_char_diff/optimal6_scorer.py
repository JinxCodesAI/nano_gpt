...
init_from_checkpoint='out/optimal5_bert_8000.pt'
unmasking_model_checkpoint='out/optimal5_bert_8000.pt'
...
unmasking_stages = [
    ...
    {'type':'random','max_masked_ratio': 0.01, 'val_loss_stale_count': 10},
