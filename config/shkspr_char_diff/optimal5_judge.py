...
wandb_run_name = 'shkspr_char_judge' # 'run' + str(time.time())
batch_size = 16
...
training_type = 'unmasking'  # 'unmasking', 'sequence_scoring', or 'remasking_binary' - type of training
use_all_stages_for_training = True
weight_loss_by_mask_ratio = True
enable_entropy_penalty = False
uncertainty_factor = 0.1

judge_model_checkpoint = "out/2000_5_scorer.pt"
...
unmasking_stages = [
    ...
    {'type': 'span', 'spans_count': 50, 'val_loss_stale_count': 10},
